...
export class PointerLockManager extends EventTarget {
  ...
  #listen() {
    const pointerlockchange = e => {
      ...
      // console.log('pointer lock change 2', pointerLockElement, e);
      ...
      // console.log('new pointer lock element', this.pointerLockElement, this);
    ...
    // const requestPointerLock = async e => {
    //   // console.log('got', e.data);
    //   await this.requestPointerLock();
    // };
    // this.ioBus.registerHandler('requestPointerLock', requestPointerLock);
    // this.unlistenFns.push(() => {
    //   this.ioBus.unregisterHandler('requestPointerLock', requestPointerLock);
    // });
  }
        ...
        await new Promise((accept, reject) => {
          ...
          if (document.pointerLockElement !== canvas) {
            ...
            const _pointerlockchange = e => {
              // console.log('pointer lock change 1', e);
