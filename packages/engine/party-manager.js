...
export class PartyManager extends EventTarget {
  constructor({
    ...
    if (!playersManager || !characterSelectManager || !importManager || !loreManager || !engine) {
  ...
  async initDefaultPlayer() {
    ...
    this.loreManager.addPlayerSpec(player.playerId, player.playerSpec);
  }
