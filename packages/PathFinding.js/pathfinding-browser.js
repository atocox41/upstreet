    ...
    while (!openList.empty()) {
        ...
        for (i = 0, l = neighbors.length; i < l; ++i) {
            ...
            if (!neighbor.opened || ng < neighbor.g) {
                neighbor.g = ng;
                neighbor.h = neighbor.h || weight * heuristic(abs(x - endX), abs(y - endY), node, neighbor);
    ...
    while (!startOpenList.empty() && !endOpenList.empty()) {
        ...
        for (i = 0, l = neighbors.length; i < l; ++i) {
            ...
            if (!neighbor.opened || ng < neighbor.g) {
                ...
                neighbor.h = neighbor.h ||
                    weight * heuristic(abs(x - endX), abs(y - endY), neighbor);
                neighbor.f = neighbor.g + neighbor.h;
                neighbor.parent = node;
        ...
        for (i = 0, l = neighbors.length; i < l; ++i) {
            ...
            if (!neighbor.opened || ng < neighbor.g) {
                neighbor.g = ng;
                neighbor.h = neighbor.h ||
                    weight * heuristic(abs(x - startX), abs(y - startY), neighbor);
                neighbor.f = neighbor.g + neighbor.h;
                neighbor.parent = node;
...
IDAStarFinder.prototype.findPath = function(startX, startY, endX, endY, grid) {
    ...
    // Heuristic helper:
    var h = function(a, b) {
        return this.heuristic(Math.abs(b.x - a.x), Math.abs(b.y - a.y), neighbor);
    }.bind(this);
    ...
    for(i = 0, l = neighbors.length; i < l; ++i) {
        ...
        if (jumpPoint) {
            ...
            if (!jumpNode.opened || ng < jumpNode.g) {
                jumpNode.g = ng;
                jumpNode.h = jumpNode.h || heuristic(abs(jx - endX), abs(jy - endY), neighbor);
