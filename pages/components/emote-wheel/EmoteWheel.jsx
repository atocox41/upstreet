...
// import emoteManager, {
//   emotes,
// } from '../emotes/emote-manager.js';

import emotes from '../../../packages/engine/managers/emote/emotes.json';
...
export const EmoteWheel = () => {
  ...
  // console.log('render emote wheel');

  const keydown = e => {
    // console.log('emote wheel keydown', open, e.key);
