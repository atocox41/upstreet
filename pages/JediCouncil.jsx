  ...
  const [objects, setObjects] = useState(() => {
    const a = [
      ...
      },
      {
        ...
        "content": {
          "name": "M3 Metaverse Makers Mastermind",
          "description": `\
...
`,
      ...
      /* {
        ...
        start_url: `/models/the_matrix_chair.glb`,
      }, */

      {
        ...
        content: {
          ...
          bio: "Uni is not just salty about being 2D, she's also incredibly petty. She holds grudges over the smallest things and is always seeking revenge. She's also incredibly stubborn, refusing to admit when she's wrong.",
        },
      },
      {
        "position": [
...
export const JediCouncilApp = () => {
  return (
    <JediCouncilAppContent />
  );
};