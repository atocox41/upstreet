...
export default class Flower
{
  ...
  create() {
    const particleCount = this.terrainState.flowerPositions.length / 3;
    if (particleCount > 0 && this.terrainState.size === chunkMinSize) {
      const geometry = this.getGeometry(
        this.view.instancesManager.flowerGeometry, 
        this.terrainState.flowerPositions, 
        this.terrainState.flowerTerrainSlopes,
      );
      this.mesh = new THREE.InstancedMesh(geometry, this.view.instancesManager.flowerMaterial, particleCount);
