...
ALTER TABLE public.conversations ALTER COLUMN message_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.conversations_message_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY public.conversations
    ADD CONSTRAINT conversations_pkey PRIMARY KEY (message_id);
...
ALTER TABLE ONLY public.usage
    ADD CONSTRAINT usage_pkey PRIMARY KEY (user_id);
...
--
-- Name: conversations_embedding_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.accounts
    ADD CONSTRAINT accounts_id_fkey FOREIGN KEY (id) REFERENCES public.accounts(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.conversations
    ADD CONSTRAINT conversations_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.accounts(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.generations
    ADD CONSTRAINT generations_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.accounts(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.subscriptions
    ADD CONSTRAINT subscriptions_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.accounts(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.tokens
    ADD CONSTRAINT tokens_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.accounts(id) ON DELETE SET NULL;


--
-- Name: usage usage_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.usage
    ADD CONSTRAINT usage_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.accounts(id) ON DELETE SET NULL;
...
--
-- Name: generations Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: accounts Enable select for users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable select for users" ON public.accounts FOR SELECT USING (true);


--
-- Name: subscriptions Enable select for users based on user_id; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable select for users based on user_id" ON public.subscriptions FOR SELECT USING ((auth.uid() = user_id));


--
-- Name: accounts Enable set for users based on id; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable set for users based on id" ON public.accounts USING ((auth.uid() = id));


--
-- Name: generations Enable update for users based on user_id; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable update for users based on user_id" ON public.generations USING ((auth.uid() = user_id));


--
-- Name: tokens Enable update for users based on user_id; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable update for users based on user_id" ON public.tokens USING ((auth.uid() = user_id));
...
--
-- Name: objects Give users access to own folder 1h9qf27_0; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Give users access to own folder 1h9qf27_0" ON storage.objects FOR SELECT USING (((bucket_id = 'mirror'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));


--
-- Name: objects Give users access to own folder 1h9qf27_1; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Give users access to own folder 1h9qf27_1" ON storage.objects FOR INSERT WITH CHECK (((bucket_id = 'mirror'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));


--
-- Name: objects Give users access to own folder 1h9qf27_2; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Give users access to own folder 1h9qf27_2" ON storage.objects FOR UPDATE USING (((bucket_id = 'mirror'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));


--
-- Name: objects Give users access to own folder 1h9qf27_3; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Give users access to own folder 1h9qf27_3" ON storage.objects FOR DELETE USING (((bucket_id = 'mirror'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));
...
--
-- Name: SEQUENCE conversations_message_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.conversations_message_id_seq TO anon;
GRANT ALL ON SEQUENCE public.conversations_message_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.conversations_message_id_seq TO service_role;
